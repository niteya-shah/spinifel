        ...
        if (
            ...
            if generation == 0:
                ...
                if settings.use_network_prior:
                    ...
                    # mask = rho_estimated_ > (rho_estimated_.max() * 0.01)
                    # rho_estimated_ = rho_estimated_ * mask
                    save_mrc(settings.out_dir / f"rho-network-estimation-0.mrc", rho_estimated)
                    image.show_volume(rho_estimated, settings.Mquat, "rho_phased_network_0.png")
            ...
            if settings.use_network_prior and generation < 5:
                network_ratio = 1 - (generation-2) / 5
                logger.log(f"combine {network_ratio:.3f} network estimation.")
                ...
                rho_ = rho_ * (1-network_ratio) + rho_estimated_ * network_ratio
                ...
                ac_phased = ac_phased * (1-network_ratio) + ac_phased_estimated * network_ratio
