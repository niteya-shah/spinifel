...
simple_mapper_header = subprocess.check_output(
    ["gcc", "-E", "-P", simple_mapper_h_path]
).decode("utf-8")
legion_mappers_so_path = os.path.join(
    root_dir, "legion_mapper", "build", "liblegion_mappers.so"
)
