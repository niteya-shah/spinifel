...
def main():
    ...
    ref_orientations, ref_orientations_p, match_summary, match_summary_p, dist_summary, dist_summary_p, match_summary_p_nnodes, dist_summary_p_nnodes = setup_match()
