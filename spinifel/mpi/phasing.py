...
from spinifel.sequential.phasing import phase_final as sequential_phase_final
...
def phase_final(generation, ac, support_, rho_):
    ...
    ac_phased, support_, rho_ = sequential_phase_final(
        generation, ac, support_, rho_)
