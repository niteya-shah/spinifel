...
class PySpinifel(BundlePackage):
    ...
    depends_on("py-tqdm")
    depends_on("legion@73e0d58252cc111f042591fcec8d3aa4a07e2301=cr ~cuda ~rocm +python +bindings +shared +openmp +hdf5 max_dims=4 max_num_nodes=4096 network=gasnet")
